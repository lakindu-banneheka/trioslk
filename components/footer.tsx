        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <Link href="https://facebook.com/trioslk" className="text-gray-300 hover:text-red-500 transition-colors" target="_blank">
                <Facebook className="h-5 w-5" />
                <span className="sr-only">Facebook</span>
              </Link>
              <Link href="https://www.tiktok.com/@trios_lk" className="text-gray-300 hover:text-red-500 transition-colors" target="_blank">
              ...
              <Link href="https://instagram.com" className="text-gray-300 hover:text-red-500 transition-colors" target="_blank">
